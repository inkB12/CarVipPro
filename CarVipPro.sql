...
-- 6. Order (đơn hàng) – liên kết Customer, Account; (ĐÃ BỎ PromotionId)
...
-- 7. OrderDetail (chi tiết đơn) – mỗi dòng gắn 1 ElectricVehicle
...
-- 8. DriveSchedule (đặt lịch lái thử) – EV + Customer + Account (nhân sự phụ trách)
